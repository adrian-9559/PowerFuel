...
const Footer = () => {
    ...
    return (
        <>
            <div
                class="flex items-center justify-center border-b-2 border-t-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
            ...
            <div class="bg-black/5 p-6 text-center">
                ...
                <a class="font-semibold" href="https://tw-elements.com/">PowerFuel</a>
            </div>
        </>
    );
}
