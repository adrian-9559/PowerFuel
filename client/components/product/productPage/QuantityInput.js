...
const QuantityInput = ({ id }) => {
    ...
    return (
        <section>
            ...
            <Button color="primary" auto className='w-full py-2 mt-4 text-white bg-blue-500 rounded hover:bg-blue-600' onClick={handleAddToCart}>
