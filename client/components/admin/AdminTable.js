...
const AdminTable = ({ dataItems, columns, selectedRows, setSelectedRows, totalPages, page, setPage, handleEditClick }) => {
                                ...
                                <TableRow key={row['id']} aria-label={`Row ${rowIndex}`}>
                                    ...
                                    <TableCell className="flex justify-center items-center">
                                        <Tooltip color="success" content="Editar" delay={750} closeDelay={1000} className='text-white'>
                                            <Button  onClick={() => handleEditClick(row['id'])} color="success" aria-label="Edit Button" isIconOnly>
